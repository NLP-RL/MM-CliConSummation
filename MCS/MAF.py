...
SOURCE_COLUMN = 'Dialogue_wo_disease'
TARGET_COLUMN = "One_line_patient_summary"
...
def train(model,
    ...
    for epoch in range(MAX_EPOCHS):
        ...
        test_results['rouge_1'], test_results['rouge_2'], test_results['rouge_L'], test_results['bleu_1'], test_results['bleu_2'], test_results['bleu_3'], test_results['bleu_4'], test_results['meteor'],test_results['BS'], test_results['JS'] ))
...
def get_val_scores(model,
    ...
    if "Test" in desc:
        ...
        file_name = "./Gen/" + str(epoch+1) + "_test_MDS_T_results.csv"
...
#test_data.to_csv("/home/abhisek_1921cs16/New/MMCSG/Multimodal_summary_5/Test_results_T_PS/test_data.csv")
